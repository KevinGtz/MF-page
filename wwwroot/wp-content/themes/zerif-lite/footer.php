...
<div class="container">
	...
	<?php
		$footer_sections = 0;
		$zerif_address = get_theme_mod('zerif_address',__('ITAM Ciudad de México','zerif-lite'));
		$zerif_address_icon = get_theme_mod('zerif_address_icon',get_template_directory_uri().'/images/map25-redish.png');
		
		$zerif_email = get_theme_mod('zerif_email','<a href="mailto:contacto@massivefunding.com">contacto@massivefunding.com</a>');
		$zerif_email_icon = get_theme_mod('zerif_email_icon',get_template_directory_uri().'/images/envelope4-green.png');
		
		$zerif_phone = get_theme_mod('zerif_phone','<a href="tel:1 223 445 55">1 332 548 954</a>');
		...
		!empty($zerif_copyright)):
					...
					if(!empty($zerif_socials_facebook) || !empty($zerif_socials_twitter) || !empty($zerif_socials_linkedin) || !empty($zerif_socials_behance) || !empty($zerif_socials_dribbble)):
						...
						if( !empty($zerif_socials_linkedin) ):
							echo '<li><a target="_blank" href=""><i class="fa fa-linkedin"></i></a></li>';
						endif;
						/* behance */
						if( !empty($zerif_socials_behance) ):
							echo '<li><a target="_blank" href=""><i class="fa fa-behance"></i></a></li>';
						endif;
						/* dribbble */
						if( !empty($zerif_socials_dribbble) ):
							echo '<li><a target="_blank" href=""><i class="fa fa-dribbble"></i></a></li>';
						endif;
						echo '</ul>';
					endif;	
					...
					echo '<div class="zerif-copyright-box"><a class="zerif-copyright" href="" target="_blank" rel="nofollow">Massive Funding </a>'.__('powered by','zerif-lite').'<a class="zerif-copyright" href="http://hackamano.segundamano.mx/" target="_blank" rel="nofollow"> Hackamano </a></div>';
