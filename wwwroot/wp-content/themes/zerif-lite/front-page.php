			...
			<div class="container">
				...
				<div class="section-header">
					...
					<?php
						...
						$zerif_contactus_title = get_theme_mod('zerif_contactus_title','¿Quieres saber más?');
				...
				<div class="row">
					...
					<form role="form" method="POST" action="" onSubmit="this.scrollPosition.value=(document.body.scrollTop || document.documentElement.scrollTop)" class="contact-form">
						...
						<div class="col-lg-6 col-sm-6" data-scrollreveal="enter left after 0s over 1s">
							...
							<input required="required" type="text" name="mysubject" placeholder="Nombre de la Startup" class="form-control input-box" value="<?php if(isset($_POST['mysubject'])) echo esc_attr($_POST['mysubject']);?>">
						...
						<div class="col-lg-6 col-sm-6" data-scrollreveal="enter left after 0s over 1s">
							...
							<input required="required" type="text" name="myname" placeholder="Página Web" class="form-control input-box" value="<?php if(isset($_POST['myname'])) echo esc_attr($_POST['myname']);?>">
						...
						<div class="col-lg-6 col-sm-6" data-scrollreveal="enter right after 0s over 1s">
							...
							<input required="required" type="text" name="mymessage" placeholder="Nombre del Emprendedor" class="form-control input-box" value="<?php if(isset($_POST['mymessage'])) echo esc_attr($_POST['mymessage']);?>">
						...
						<div class="col-lg-6 col-sm-6" data-scrollreveal="enter left after 0s over 1s">
							...
							<input required="required" type="email" name="myemail" placeholder="Correo del Emprendedor" class="form-control input-box" value="<?php if(isset($_POST['myemail'])) echo is_email($_POST['myemail']) ? $_POST['myemail'] : ""; ?>">
